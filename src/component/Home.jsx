            ...
            <div className="md:w-full flex justify-center items-center w-full">
                <div className="flex flex-col">
                    ...
                    <div className='mt-4 z-0 flex justify-center items-center'>
                        <a href="https://github.com/rishikesh094" target='_blank' className='px-2 m-4 text-5xl text-white'>
                            <FontAwesomeIcon icon={faGithub} />
                        </a>
                        <a href="https://www.linkedin.com/in/rishikesh-singh-888a6a281/" target='_blank' className='px-2 m-4 text-5xl text-white'>
                            <FontAwesomeIcon icon={faLinkedin} />
                        </a>
                        <a href="https://x.com/rishikeshs820" target='_blank' className='px-2 m-4 text-5xl text-white'>
